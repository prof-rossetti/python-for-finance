...
[**II. Applied Data Science for Finance in Python**](./courses/applied-ds.qmd): in this intermediate course, students will build the skills to effectively navigate, wrangle, and analyze financial datasets in Python, including performing statistical analyses.

[**III. Financial Modeling in Python**](./courses/fin-modeling.qmd): in this advanced course, students will learn fundamental concepts and techniques for building and evaluating predictive models in Python, including for time series forecasting.
