...
::: {.callout-note}
When you access a notebook that has been shared with you, unelss you have "Editor" privileges, you won't be able to save your work, and any edits you make in that document will be lost.
...
![Recommended editor settings in Google Colab](../../../images/colab-settings.png)
...
In the text cells, we can write in plain text, or in a special syntax called Markdown.
...
The sidebar menus provide additional functionality. The Table of Contents is fairly straightforward, but you can feel free to review other menus like the [Filesystem](./colab-filesystem.ipynb), Code Snippets, and Notebook Secrets in the future, when we have practical need for them.

  + [Table of Contents](#table-of-contents)
  + [Colab Filesystem](./filesystem.ipynb)
  + [Notebook Secrets](./notebook-secrets.qmd)
  + [Code Snippets and Advanced Integrations](./integrations.qmd)

### Table of Contents

The table of contents menu shows a document outline, similar to a table of contents in word processing software.
