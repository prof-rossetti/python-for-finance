...
An ARIMA model has three key components:
  ...
  + **AutoRegressive (AR)** part: This involves regressing the current value of the series against its past values (lags). The idea is that past observations have an influence on the current value.
...
dates = date_range(start=recent, periods=future_periods, freq="YS")
