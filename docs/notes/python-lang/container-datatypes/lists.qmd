...
Loops are essentially important and foundational. They will form the basis of more advanced operations, such as [mapping](../../data-processing/mapping.qmd) and [filtering](../../data-processing/filtering.qmd).

### Data Processing Operations

These chapters go into more depth about list-based data processing techniques:
