...
After running into an error for the first time, we should observe what [type of error](https://docs.python.org/3/library/exceptions.html#bltin-exceptions) we are experiencing (e.g. `KeyError`, `IndexError`, `DivisionByZeroError`, etc.).
