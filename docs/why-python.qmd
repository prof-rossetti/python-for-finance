...
Many finance professionals already possess a deep knowledge of spreadsheet software. So why is it helpful for them to learn [Python](https://www.python.org/) as well?

![Python logo](./images/python-logo.png){height=150}
